...
export default function NotificationProvider({children}){
    ...
    return <NotificationContext.Provider value={{updateNotification}}>{children}
    {notification && <div className={classes + " fixed left-1/2 -translate-x-1/2  rounded rounded-t-none"}>
